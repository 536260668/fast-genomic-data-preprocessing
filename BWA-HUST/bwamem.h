...
extern "C" {
	 ...
	 */
	void mem_process_seqs(const mem_opt_t *opt, const lbwt_t *lbwt, const bntseq_t *bns, const uint8_t *pac, int64_t n_processed, int n, bseq1_t *seqs, const mem_pestat_t *pes0, kt_for_t *t);

    void mem_process_seqs2(const mem_opt_t *opt, FMI_search* fmi, LISA_search<index_t>* lisa, int64_t n_processed, int n, bseq1_t *seqs, const mem_pestat_t *pes0, kt_for_t *t);
